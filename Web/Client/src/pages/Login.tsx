...
// import LoginAsOwner from "../components/LoginComponents/LoginAsOwner";
import LoginAsPartner from "../components/LoginComponents/LoginAsPartner";
    ...
    <div className="container">
      <div className="header">
        ...
        {/* <div className="account_type">
          <Link to={'asOwner'} className="owner" style={{ border: '1px solid', borderColor: isOwner ? "rgb(141, 122, 56)" : "grey" }} onClick={e => handleAccount(e)} >As Owner</Link>
      ...
      {/* 
      <Routes>
        <Route path="asOwner" element={<LoginAsOwner />} />
        <Route path="asPartner" element={<LoginAsPartner />} />
      </Routes> */}
